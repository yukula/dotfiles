...
tracked_files["${HOME}/.config/nvim/bindings.vim"]=".config/nvim/bindings.vim"
tracked_files["${HOME}/.config/nvim/init.vim"]=".config/nvim/init.vim"
tracked_files["${HOME}/.config/nvim/plugins.vim"]=".config/nvim/plugins.vim"
