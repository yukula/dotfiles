local function map_split(buf_id, lhs, direction)
    ...
    vim.keymap.set('n', lhs, rhs, { buffer = buf_id, desc = 'Split ' .. string.sub(direction, 12), nowait = true })
end
        ...
        config = function(_, opts)
            ...
            vim.api.nvim_create_autocmd('User', {
                ...
                callback = function(args)
                    ...
                    map_split(buf_id, '<C-w>d', 'belowright horizontal')
                    map_split(buf_id, '<C-w>r', 'belowright vertical')
                end,
            })
        end,
    },
